...
export const movieList : Movie[] = [
    {
        ...
        release: "1999",
        duration: "2 h 16 min",
        synopsis: `Deux chevaliers Jedi échappent à un blocus hostile pour trouver des alliés lorsqu'ils rencontrent un jeune garçon qui pourrait apporter un équilibre à la Force, mais les Sith, longtemps inactifs, refont surface pour réclamer leur ancienne gloire.`,
    ...
    },
    {
        ...
        release: "2002",
        duration: "2 h 22 min",
        synopsis: `Dix ans après sa rencontre originale, Anakin Skywalker a une aventure interdite avec Padmé Amidala, alors que Obi-wan Kenobi enquêtait sur un attentat contre le sénateur et découvre une armée clonée secrète, fabriquée pour les Jedi.`,
    ...
    },
    {
        ...
        release: "2008 - 2020",
        duration: "7 saisons",
        synopsis: `Yoda, Mace Windu, Obi-Wan Kenobi, Anakin Skywalker et d'autres chevaliers Jedi dirigent la Grande Armée de la République contre l'armée droïde des Séparatistes.`,
    ...
    },
    {
        ...
        release: "2005",
        duration: "2 h 20 min",
        synopsis: `Dans la troisième année de la Guerre des Clones, le Jedi sauve Palpatine du Comte Dooku. Alors qu'Obi-Wan se lance à la poursuite d'une nouvelle menace, Anakin agit comme agent double entre le Conseil Jedi et Palpatine, et il est attiré dans un plan sinistre pour régner sur la galaxie.`,
    ...
    },
    {
        ...
        release: "2021 - 2022",
        duration: "2 saisons",
        synopsis: `Le «Bad Batch», une troupe d'élite de clones expérimentaux se fraye un chemin à travers une galaxie en constante évolution au lendemain de la guerre des clones.`,
    ...
    },
    {
        ...
        release: "2018",
        duration: "2 h 15 min",
        synopsis: `Au cours d'une aventure dans la pègre, Han Solo rencontre son futur co-pilote Chewbacca ainsi que Lando Calrissian des années avant de rejoindre la Rébellion.`,
    ...
    },
    {
        ...
        release: "2022",
        duration: "1 saison",
        synopsis: `Le Maître Jedi Obi-Wan Kenobi veille en secret sur le jeune Luke Skywalker et doit échapper aux chasseurs élites de l'Empire durant son exil sur la planète désertique Tatooine.`,
    ...
    },
    {
        ...
        release: "2014 - 2017",
        duration: "4 saisons",
        synopsis: `Un équipage courageux et malin se dresse contre l'Empire maléfique alors qu'il renforce son emprise sur la galaxie et pourchasse le dernier des Chevaliers Jedi (Jedi Knights).`,
    ...
    },
    {
        ...
        release: "2016",
        duration: "2 h 14 min",
        synopsis: `La fille d'un scientifique impérial se joint à l'Alliance Rebelle dans une tentative risquée pour voler les plans de l'Étoile de la mort.`,
    ...
    },
    {
        ...
        release: "1977",
        duration: "2 h 04 min",
        synopsis: `Luke Skywalker se joint à un chevalier Jedi, un pilote arrogant, un Wookiee et à deux droïdes pour sauver la galaxie de l'Empire, tout en essayant de sauver la princesse Léia du maléfique Dark Vador.`,
    ...
    },
    {
        ...
        release: "1980",
        duration: "2 h 07 min",
        synopsis: `Après que les rebelles soient brutalement maîtrisés par l'Empire sur la planète de glace Hoth, Luke Skywalker commence son entraînement de Jedi avec Yoda, tandis que ses amis sont poursuivis par Dark Vador.`,
    ...
    },
    {
        ...
        release: "2021",
        duration: "1 saison",
        synopsis: `Un spin-off de "The Mandalorian" qui met en vedette Temeura Morrison dans le rôle de Boba Fett et Ming-Na Wen dans le rôle de Fennec Shand.`,
    ...
    },
    {
        ...
        release: "2015",
        duration: "2 h 18 min",
        synopsis: `Trente ans après la défaite de l'Empire, une nouvelle menace apparaît au sein du Premier Ordre. Le Stormtrooper déserteur Finn et Rey se retrouvent impliqués par la Résistance dans la recherche de Luke Skywalker.`,
    ...
    },
    {
        ...
        release: "2017",
        duration: "2 h 32 min",
        synopsis: `Rey continue de développer ses nouvelles capacités en suivant les conseils de Luke Skywalker, qui se voit déstabilisé par la force de ses pouvoirs. Pendant ce temps, la Résistance se prépare au combat contre le Premier Ordre.`,
    ...
    },
    {
        ...
        release: "2019",
        duration: "2 h 21 min",
        synopsis: `La conclusion de la nouvelle trilogie «Star Wars».`,
